...
const roleDetails = {
  USER: {
    label: "Support Admin",
    description:
      "Supports customer records, applications, loans and repayments.",
  },
  ADMIN: {
    label: "Admin",
  ...
  SUPER_ADMIN: {
    label: "Super Admin",
    description:
      "Has full access to system configuration and staff management.",
  },
};

const currentRole = computed(() => {
  return (
    roleDetails[auth.role] || {
    ...
    >
      ...
      >
        ...
        <div class="space-y-4 p-5">
          <div
            class="-mt-12 h-16 w-16 animate-pulse rounded-full border-4 border-white bg-slate-300"
          />
        ...
        <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div class="grid px-5 sm:grid-cols-2 sm:gap-x-8 sm:px-6">
            ...
            <div class="border-b border-slate-100 py-4">
              ...
              <strong
                class="mt-1.5 block break-all text-sm font-semibold text-slate-900"
              >
                {{ auth.user?.email || "—" }}
              </strong>
            </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p class="mt-0.5 text-sm text-slate-500">
                Important account dates and identifiers.
              </p>
            </div>
            <div
              class="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-100 text-slate-600"
          ...
          <div class="grid px-5 sm:grid-cols-2 sm:gap-x-8 sm:px-6">
            ...
            <div class="py-4">
              ...
              <strong
                class="mt-1.5 block break-all font-mono text-xs font-semibold text-slate-900"
              >
                {{ auth.user?.id || "—" }}
              </strong>
            </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p class="mt-0.5 text-sm text-slate-500">
                Permissions included with this account.
              </p>
            </div>
            <span
