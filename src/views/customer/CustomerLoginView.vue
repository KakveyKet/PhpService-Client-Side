  ...
  <main class="flex min-h-dvh items-center justify-center bg-white px-4 py-10">
    <section class="w-full max-w-sm">
      <div class="text-center">
        <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-600 text-white">
        ...
        <p class="mt-1 text-sm text-slate-500">Sign in to your customer account.</p>
      </div>
