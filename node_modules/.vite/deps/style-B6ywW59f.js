import { Ft as onMounted, Gn as readonly, Kn as ref, Ot as nextTick, gn as watch, ut as getCurrentInstance } from "./vue.runtime.esm-bundler-Dx_VcfX4.js";
import { t as s$1 } from "./eventbus-DVt0UsMd.js";
...
function st$1(t) {
	typeof t == "string" ? W$1(document.body, t || "p-overflow-hidden") : (t != null && t.variableName && document.body.style.setProperty(t.variableName, F$2() + "px"), W$1(document.body, (t == null ? void 0 : t.className) || "p-overflow-hidden"));
}
function B$1(t) {
	if (t) {
...
var b = {
	...
	getCommon({ name: e = "", theme: t = {}, params: r, set: s$3, defaults: i }) {
		...
		if (s(a) && n.transform !== "strict") {
			...
			c = `${this.transformCSS(e, `${Ke}${Ge}`, "light", "variable", n, s$3, i)}${this.transformCSS(e, `${Be}`, "dark", "variable", n, s$3, i)}`, m$1 = [.../* @__PURE__ */ new Set([
				...Xe,
				...Ue,
				...Ie
			])];
			d = `${this.transformCSS(e, `${He}${qe}color-scheme:light`, "light", "variable", n, s$3, i)}${this.transformCSS(e, `${Fe}color-scheme:dark`, "dark", "variable", n, s$3, i)}`, u = [.../* @__PURE__ */ new Set([
				...We,
				...Ze,
				...Je
			])], g = m(a.css, { dt: E });
...
var BaseStyle = {
	...
	load: function load(style) {
		...
		return s(computedStyle) ? useStyle(Y$1(computedStyle), _objectSpread({ name: this.name }, options)) : {};
	},
...
//#endregion
export { _t as $, C$2 as A, Mt as B, m as C, s as D, q as E, I as F, S$1 as G, P as H, It as I, V as J, Tt as K, J$1 as L, Dt as M, G$1 as N, $t as O, Ht as P, Yt as Q, K$1 as R, l as S, p as T, Q$1 as U, Ot as V, Rt as W, Wt as X, W$1 as Y, Y$2 as Z, ee as _, x as a, et as at, i as b, F$1 as c, pt as ct, M as d, v$1 as dt, at as et, O as f, vt as ft, c as g, a as h, rr as i, dt$1 as it, D as j, At as k, H as l, st$1 as lt, X as m, N as n, bt as nt, B as o, h$2 as ot, W as p, z$1 as pt, U as q, S as r, c$1 as rt, C$1 as s, kt as st, BaseStyle as t, b$2 as tt, J as u, tt as ut, g$1 as v, ne$1 as w, k$1 as x, h$1 as y, Lt as z };
